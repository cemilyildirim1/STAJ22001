...
import com.cemilyildirim.superkahramankitabi.databinding.ActivityMainBinding


class MainActivity : AppCompatActivity() {
    lateinit var binding : ActivityMainBinding
    lateinit var superKahramanListesi : ArrayList<SuperKahraman>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val superman = SuperKahraman("Superman","Gazeteci",R.drawable.suparman)
