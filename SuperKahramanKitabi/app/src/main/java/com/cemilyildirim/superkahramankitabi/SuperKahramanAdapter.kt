...
import com.cemilyildirim.superkahramankitabi.databinding.RecyclerRowBinding
...
class SuperKahramanAdapter (val superKahramanListesi  : ArrayList<SuperKahraman>) : RecyclerView.Adapter<SuperKahramanAdapter.SuperKahramanViewHolder>() {
    ...
    override fun onBindViewHolder(
        holder: SuperKahramanViewHolder,
        position: Int
    ) {
        holder.binding.textRecyclerView.text = superKahramanListesi[position].isim
